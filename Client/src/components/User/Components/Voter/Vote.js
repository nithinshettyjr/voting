...
export default function CustomizedTables() {
    ...
    useEffect(() => {
        ...
        axios.get(`${BASE_URL}/getVoterbyID/${voterid}`)
            .then((response) => {
                ...
                console.log("response",response.data.voter);
            })
            .catch(error => {
    ...
    const handleClose = () => {
        setOpen(false);
        navigate("/User",{state:{voterst: {id: voterid}}});
    }
    ...
    const handleVote = (id) => {
        ...
        if (voter.voteStatus) {
            ...
            voter.timeOfVote = new Date();
            
            axios.patch(`${BASE_URL}/getCandidate/${id}`)
                .then(response => {
                    console.log("Updated Candidate Details:",response.data);
            ...
            // axios.patch(`${BASE_URL}/updateVoter/${voter._id}`);
        };
    }
